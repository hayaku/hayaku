...
# CSS_DICT = parse_dict_json(sublime.load_settings('Preferences.sublime-settings').get('hayaku_css_dict'))

CSS_DICT = parse_dict_json(json.loads(CSS_DICT_JSON))
...
FLAT_CSS = list(chain.from_iterable(starmap(css_flat_list, ((i, CSS_DICT) for i in CSS_DICT))))
